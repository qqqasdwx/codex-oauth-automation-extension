...
- `tests/verification-flow-polling.test.js`：测试 2925 长轮询参数、验证码提交流程中的 `beforeSubmit` 钩子执行顺序、验证码提交改为“先回执再轮询结果”的链路，以及步骤 8 提交验证码后在默认模式下进入手机号页会报 fatal、在 Hero-SMS 模式下可转入手机号验证分支。
