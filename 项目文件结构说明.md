...
- `.github/workflows/release.yml`：GitHub Actions 发布工作流；在推送 `Pro* / v*` 标签或手动触发时创建 GitHub Release，其中 `Pro*` 标签会额外校验 `manifest.json` 的 `version_name` 与标签一致，确保 fork 发版版本号跟随当前代码版本。
